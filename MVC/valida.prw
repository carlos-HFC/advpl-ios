...
Static function ModelDef() //sempre staticfunction
    ...
    oStruZA4:AddField('DESCRI', ' ', 'Nome do Álbum', 'C', 30, 0, , , {}, .F.,)
...
Static Function ViewDef() //sempre static function
    ...
    oStructZA4:AddField( 'DESCRI','01','DESCRI','DESCRI',, '')
    ...
    oView:CreateVerticalBox("BOX_SEL2",50, 'ESP2')    
    ...
    oView:SetOwnerView('PANEL_SEL2','BOX_SEL2')
